        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex items-center gap-2">
              <h1 className="font-extrabold text-base md:text-lg text-slate-800 tracking-tight">
                تصاویر کلینیکال جراحی
              </h1>
              <span className="px-2 py-0.5 text-[11px] font-mono-numbers rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 font-semibold flex items-center gap-1.5">
